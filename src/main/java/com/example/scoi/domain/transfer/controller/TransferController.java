...
public class TransferController {
    ...
    @ApiResponses({
            ...
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "TRANSFER404_1", description = "사용자를 찾을 수 없습니다."),
    ...
    public ApiResponse<TransferResDTO.RecipientListDTO> getRecentRecipients(
        ...
        return ApiResponse.onSuccess(
                TransferSuccessCode.TRANSFER200_1, transferService.getRecentRecipients(member, cursor, limit));
    }
}
