...
public enum ChargeErrorCode implements BaseErrorCode {
    ...
    WRONG_COIN_TYPE(HttpStatus.BAD_REQUEST,
            "CHARGE400_7",
            "코인 심볼을 잘못 입력했습니다."),
    NOT_SUPPORT_COIN(HttpStatus.BAD_REQUEST,
            "CHARGE400_8",
            "해당 거래소에서 지원하지 않는 코인입니다."),
    NOT_SUPPORT_NET_TYPE(HttpStatus.BAD_REQUEST,
            "CHARGE400_9",
            "해당 거래소에서 지원하지 않는 네트워크입니다."),
